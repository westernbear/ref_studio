...
const dashboard = readFileSync(resolve(root, "apps/web/src/components/AdminDashboard.tsx"), "utf8")
const shell = readFileSync(resolve(root, "apps/web/src/components/Shells.tsx"), "utf8")
