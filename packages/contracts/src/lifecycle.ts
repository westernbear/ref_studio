...
export const PublicJobStates = ["QUEUED", "PREPARING", "RENDERING", "COMPLETED", "CANCELLED", "FAILED"] as const
...
export const isLegalTransition = (from: JobState, to: JobState): boolean => transitions[from].includes(to)
