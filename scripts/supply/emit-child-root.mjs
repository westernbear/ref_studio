...
if (expectedParent === undefined)
  throw new Error("RVS_AUTHORITY_ROOT_SHA256 is required");
...
if (parentRootSha256 !== expectedParent)
  throw new Error("AUTHORITY_ROOT_DRIFT parent root digest mismatch");
